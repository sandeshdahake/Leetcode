 ...
 * Given an ds.bst.array arr of integers, check if there exists two integers N and M such that N is the double of M ( i.e. N = 2 * M).
 *
 ...
 *
 * Hide Hint #1
 * Loop from i = 0 to arr.length, maintaining in a hashTable the ds.bst.array elements from [0, i - 1].
 * Hide Hint #2
